  ...
  sections: {
    ...
    tools: {
      ...
      items: [
        ...
        { name: 'CleverTap', category: 'Lifecycle & Engagement', logo: '/logos/clevertap.svg', url: 'https://clevertap.com/' },
  ...
  sections: {
    ...
    tools: {
      ...
      items: [
        ...
        { name: 'CleverTap', category: 'Lifecycle y engagement', logo: '/logos/clevertap.svg', url: 'https://clevertap.com/' },
